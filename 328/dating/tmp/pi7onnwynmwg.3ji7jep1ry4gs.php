            ...
            <div class="col-md-12 col-lg-12">
                ...
                <div class="col-sm-12">
                    <?php foreach (($interests?:[]) as $interest): ?>
                        <input id="checkInputs" type="checkbox" name="indoor[]" value="<?= ($interest) ?>"> <?= ($interest)."
" ?>
                        </input>
                    <?php endforeach; ?>
                </div>
            ...
            <div class="col-md-12 col-lg-12">
                ...
                <div class="col-sm-12">
                    <?php foreach (($interests2?:[]) as $interest): ?>
                        <input class="checkInputs" type="checkbox" name="outdoor[]" value="<?= ($interest) ?>"> <?= ($interest)."
" ?>
                        </input>
                    <?php endforeach; ?>
                </div>
            ...
            <div class="text-center col-md-2 col-lg-2" id="mybutton2">
