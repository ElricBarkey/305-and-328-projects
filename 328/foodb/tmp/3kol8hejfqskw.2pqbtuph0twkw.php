...
<div class="container">
    ...
    <form action="#" method="post" class="form-horizontal">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-4">
                <input class="form-control" type="text" name="food" id="food" value="<?= ($food) ?>">
                <span class="err">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-4">
                <?php foreach (($meals?:[]) as $meal): ?>
                    <input type="radio" name="meal" id="<?= ($meal) ?>" value="<?= ($meal) ?>"
                    <?php if ($meal == $selectedMeal): ?>
                           checked = checked
                    <?php endif; ?>
                    ><?= (ucfirst($meal)) ?></input><br>
                <?php endforeach; ?>
                <span class="err">
...
<link href="styles/food.css" rel="stylesheet">
</body>
</html>